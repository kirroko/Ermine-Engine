...
#include "xproperty\source\xproperty.h"
#include "xproperty\source\sprop\property_sprop_container.h"
...
namespace xproperty::settings
{
    ...
    // Vec3
    template<> 
    struct var_type<Ermine::Vec3> : var_defaults<"vec3", Ermine::Vec3> {
        static void Write(Ermine::Vec3& dst, const Ermine::Vec3& src, context&) noexcept { dst = src; }
...
// ------------------------------------------------------------------------------
#include "xproperty\source\examples\imgui\my_property_ui.h"
