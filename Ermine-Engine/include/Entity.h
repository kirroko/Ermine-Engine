...
namespace Ermine
{
	...
	constexpr ComponentTypeID MAX_COMPONENTS = 32; // Maximum number of components that can be registered TODO: Here's to increase components amount, unsigned char is 8-bit indexing up to 255 components, if needed change componentID to uint16_t for up to 256+
