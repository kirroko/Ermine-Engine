...
DefaultDirName={pf}\DigiPen\Machina

; Start menu directory
DefaultGroupName=DigiPen\Machina
...
[Icons]
Name: {group}\Machina; Filename: {app}\Ermine-Game\Machina.exe; WorkingDir: {app}\Ermine-Game; IconFilename: "{app}\Icon.ico"
Name: {group}\{cm:UninstallProgram,Machina}; Filename: {uninstallexe}
Name: {group}\{cm:UninstallProgram,Machina}; Filename: {uninstallexe};  IconFilename: "{app}\Icon.ico"
Name: {commondesktop}\Machina; Filename: {app}\Ermine-Game\Machina.exe; Tasks: desktopicon; WorkingDir: {app}\Ermine-Game; IconFilename: "{app}\Icon.ico"
...
Filename: {app}\Ermine-Game\Machina.exe; Description: {cm:LaunchProgram,Machina}; Flags: nowait postinstall skipifsilent
