...
uniform float u_RotationSpeed = 1.0;        // Radians per second (positive = counter-clockwise)
uniform vec2 u_RotationCenter = vec2(0.5);  // Pivot point in UV space
...
void main()
{
    ...
    uv = rotateUV(uv, u_RotationCenter, angle);
